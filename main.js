...
const pinterestImgCommand = require('./commands/pinterestimg');
const bingImgCommand = require('./commands/bingimg');
const solveCommand = require('./commands/solve');
const ageCommand = require('./commands/age');
const fliptextCommand = require('./commands/fliptext');
const { setbotfontCommand } = require('./commands/setbotfont');
const bratCommand = require('./commands/brat-local');
const createGroupCommand = require('./commands/creategr');
const obfuscateCommand = require('./commands/obfuscate');
const textstickerCommand = require('./commands/textsticker');
...
const {
    ...
    handleAutoReaction,
    realownerCommand
} = require('./commands/enhanced-commands');

// Improved existing commands
const { anticallCommand: anticallImproved, handleCall } = require('./commands/anticall-improved');
const { autotypingCommand: autotypingImproved, isAutotypingEnabled: isAutotypingEnabledNew, handleAutotypingForMessage: handleAutotypingNew } = require('./commands/autotyping-improved');
const { pmblockerCommand: pmblockerImproved, readState: readPmBlockerStateNew } = require('./commands/pmblocker-improved');
