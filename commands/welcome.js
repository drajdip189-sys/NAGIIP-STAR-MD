...
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝐍𝐚𝐠𝐢𝐢𝐩 𝐒𝐭𝐚𝐫 𝐌𝐃* 🚀`;
            ...
            // If no profile pictures available, use default bot image from assets
            if (!profilePicBuffer) {
                try {
                    const defaultImagePath = path.join(__dirname, '..', 'assets', 'nagiip_md.jpg');
